...
public class ResourceCopier {
	...
	/**
	 * Copy all of the files from a resources package to a temporary directory on
	 * the file system (whether or not the code and resources are in a .jar file or
	 * on the file system).
	 * 
	 ...
	 */
	public static Path copyResourcesToTemp(String id, String subdir) throws IOException, URISyntaxException {
